...
def main():
    print(binary_tree_right_side_view(make_tree()))
    print(binary_tree_left_side_view(make_tree()))
    print(binary_tree_top_side_view(make_tree()))
    print(binary_tree_bottom_side_view(make_tree()))
